...
namespace Ophim\ThemeHoly\Controllers;
...
class ThemeHolyController
{
    ...
    public function index(Request $request)
    {
        ...
        return view('themes::themeholy.index', [
    ...
    public function getMovieOverview(Request $request)
    {
        ...
        return view('themes::themeholy.single', [
            'currentMovie' => $movie,
    ...
    public function getEpisode(Request $request)
    {
        ...
        return view('themes::themeholy.episode', [
            'currentMovie' => $movie,
            'movie_related' => $movie_related,
            'episode' => $episode,
