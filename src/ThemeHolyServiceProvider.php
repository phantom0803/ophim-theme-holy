...
namespace Ophim\ThemeHoly;

use Illuminate\Foundation\Support\Providers\AuthServiceProvider as ServiceProvider;

class ThemeHolyServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        $this->publishes([
            __DIR__ . '/../resources/assets' => public_path('themes/holy')
        ], 'holy-assets');
    }
    ...
    protected function setupDefaultThemeCustomizer()
    {
        config(['themes' => array_merge(config('themes', []), [
            'holy' => [
                ...
                'package_name' => 'ophimcms/theme-holy',
                'publishes' => ['holy-assets'],
                'preview_image' => '',
                'options' => [
                    [
