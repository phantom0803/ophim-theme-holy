<div class="col-md-2.5" style="margin-bottom: 1vh;padding-right: 4px;padding-left: 4px;">
    <div class="card" style="background: rgb(20,20,20);">
        <a href="{{$movie->getUrl()}}"><img class="card-img-top w-100 d-block" style="height: 145px" src="{{ $movie->poster_url ?: $movie->thumb_url}}" alt="{{$movie->name}} - {{$movie->origin_name}} ({{$movie->publish_year}})"></a>
